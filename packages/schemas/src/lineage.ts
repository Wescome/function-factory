 ...
 * SRR-, AMD-, MR-, CRP-, VCR-, MRP-, EP-, FORM-, EL-).
 */
export const ArtifactId = z
  .string()
  .regex(
    /^(PRS|BC|FN|CONTRACT|FP|IS|ES|INV|VAL|DEP|ATOM|VR|CTR|TRJ|PF|INC|DET|DEL|SIG|RGD|AC|ACS|RAD|EXS|EXT|EXR|EFF|EFFR|OBS|SNB|GOV|RPRS|DDI|CRL|SBI|PSR|GOVP|GOVD|GOVS|GOVA|GOVR|SRR|AMD|MR|CRP|VCR|MRP|EP|FORM|EL)-[A-Z0-9][A-Z0-9-]*$/,
