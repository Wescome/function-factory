 ...
 * SNB-, GOV-, RPRS-, DDI-, CRL-, SBI-).
 */
export const ArtifactId = z
  .string()
  .regex(
    /^(PRS|BC|FN|CONTRACT|FP|PRD|WG|INV|VAL|DEP|ATOM|CR|CTR|TRJ|PF|INC|DET|DEL|SIG|RGD|AC|ACS|RAD|EXS|EXT|EXR|EFF|EFFR|OBS|SNB|GOV|RPRS|DDI|CRL|SBI)-[A-Z0-9][A-Z0-9-]*$/,
