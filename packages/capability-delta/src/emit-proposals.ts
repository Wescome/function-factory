  ...
  "BC-META-SEMANTICALLY-REVIEW-PRDS": [
    {
      ...
      purpose: "Execute a semantic review pass between Coherence Verification and WorkGraph emission",
      functionType: "execution",
      expectedInputs: ["PRDDraft", "CoherenceVerificationReport", "reference doctrine set"],
    ...
    },
    {
      ...
      functionType: "control",
      expectedInputs: ["PRDDraft", "CoherenceVerificationReport", "doctrine sources"],
