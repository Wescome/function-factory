  ...
  "BC-META-SEMANTICALLY-REVIEW-Intent SpecificationS": [
    {
      ...
      purpose: "Execute a semantic review pass between Coherence Verification and ExecutableSpecification emission",
      functionType: "execution",
      expectedInputs: ["IntentSpecification", "CoherenceVerificationReport", "reference doctrine set"],
      expectedOutputs: ["semantic review verdict"],
      governingConstraints: ["fail-closed", "bootstrap human-governed"],
      candidateInvariants: ["semantic review is required before ExecutableSpecification emission"],
  ...
  "BC-META-EMIT-ARCHITECTURE-CANDIDATES": [
    {
      ...
      governingConstraints: ["Candidate artifact must remain separate from ExecutableSpecification", "Candidate artifact must preserve lineage"],
      candidateInvariants: ["Every emitted candidate has explicit topology and binding intent"],
      successSignals: ["Candidate artifact persisted alongside ExecutableSpecification"],
      confidence: 0.94,
    },
    {
      ...
      functionType: "control",
      expectedInputs: ["IntentSpecification", "ExecutableSpecification", "doctrine sources"],
