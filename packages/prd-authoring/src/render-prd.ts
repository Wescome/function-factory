...
export function renderPrdFromFunctionProposal(
  ...
  if (proposal.id === "FP-META-SEMANTIC-REVIEW-EXECUTION") {
    ...
    const markdown = [
      ...
      "",
      "## Problem",
      "Coherence Verification verifies structural completeness, but the current repo has no semantic review execution step capable of blocking structurally valid yet conceptually invalid PRDs before ExecutableSpecification emission.",
      "",
      "## Goal",
