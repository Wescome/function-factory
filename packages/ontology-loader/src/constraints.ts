...
export const ONTOLOGY_CONSTRAINTS: OntologyConstraint[] = [
  ...
  // ─── C1: Lineage Completeness ──────────────────────────────────
  {
    ...
    targetClasses: ['Pressure', 'BusinessCapability', 'FunctionProposal', 'IntentSpecification', 'ExecutableSpecification', 'VerificationReport'],
    severity: 'violation',
  ...
  // ─── C5: Invariant Has Detector ────────────────────────────────
  {
    ...
    severity: 'violation',
    message: 'WISH NOT INVARIANT: An Invariant without a DetectorSpec is a wish. Coherence Verification MUST reject.',
  ...
  // ─── C6: Every Artifact Reviewed ───────────────────────────────
  {
    ...
    shapeName: 'ExecutableSpecificationReviewShape',
    targetClasses: ['ExecutableSpecification', 'CodeArtifact', 'IntentSpecification'],
    severity: 'violation',
    message: 'UNREVIEWED: Every ExecutableSpecification, CodeArtifact, and IntentSpecification MUST be reviewed by an Agent before synthesis.',
  ...
  // ─── C13: ExecutableSpecification Has Atoms ──────────────────────────────────
  {
    _key: 'C13-atoms',
    constraintId: 'C13',
    name: 'ExecutableSpecification Has Atoms',
    shapeName: 'ExecutableSpecificationCompletenessShape',
    targetClasses: ['ExecutableSpecification'],
    severity: 'violation',
    message: 'EMPTY WORKGRAPH: ExecutableSpecification must have at least one node.',
  ...
  // ─── C14: Function Lifecycle Transitions ───────────────────────
  {
    ...
    lifecycleRules: [
      ...
      { from: 'Implemented', to: 'Verified', requires: 'FidelityVerification' },
      { from: 'Verified', to: 'Monitored', requires: 'PersistenceVerification' },
