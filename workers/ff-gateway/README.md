...
Ontology v0.2 names compile coverage as `Coherence Verification`. New callers should use
...
- Do not introduce new numbered compile-coverage routes. Add ontology-named routes first,
